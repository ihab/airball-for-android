...
public class Constants {
  public static final double METERS_PER_FOOT = 0.0254 * 12.0;
  public static final double STANDARD_AIR_DENSITY = 1.225;  // kg/m^3
  public static final double NEWTONS_PER_POUND = 4.45;
